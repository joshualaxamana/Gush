        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <asp:Button ID="Button1" runat="server" Text="Generate Sales Report" class="btn btn-info"/>
                            <asp:Button ID="Button2" runat="server" Text="Generate Inventory Report" class="btn btn-info" />
                        </div>
                    </div>
