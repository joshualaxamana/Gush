<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmpDeliveries.aspx.cs" Inherits="EmpDeliveries" %>
        ...
        <form id="form1" runat="server">
            <div id="page-wrapper">
                ...
                <div class="row">
                    ...
                    <asp:Button ID="addProduct" class="btn btn-info" runat="server" Text="Add to Inventory" OnClick="addProduct_Click" />
                    <asp:Button ID="cancel" class="btn btn-info" runat="server" Text="Back" OnClick="cancel_Click" />
                </div>
            </div>
        </form>
